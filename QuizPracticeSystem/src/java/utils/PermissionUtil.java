 ...
 * This class provides methods to verify if the current user has admin privileges
 * and to handle redirects for users without such privileges.
 */
public class PermissionUtil {
    ...
    public static boolean hasRole(HttpServletRequest request, String roleName) {
        ...
        String expectedRoleId = accountDAO.getRoleIdByRoleName(roleName);
        return expectedRoleId.equals(currentUser.getRoleId());
    }
     ...
     * @param request
     * @param response
     * @param requiredRoleName the name of the required role (e.g., "Admin", "Marketer")
