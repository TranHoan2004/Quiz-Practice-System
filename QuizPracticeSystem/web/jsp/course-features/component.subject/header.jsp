    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/qps/admin/dashboard" class="nav-item nav-link active">DashBoard</a>
                <a href="/qps/subject-list" class="nav-item nav-link">Subject List</a>
                <c:if test="${sessionScope.userRole eq 'Admin'}">
                    <a href="/qps/new-subject" class="nav-item nav-link">New Subject</a>
                </c:if>
