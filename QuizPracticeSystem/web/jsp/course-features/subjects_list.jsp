...
<body>
<jsp:include page="../../component/component.dashboard/header.jsp"/>
<jsp:include page="../../component/component.dashboard/header.html"/>
        ...
        <div class="row g-4">
            <div class="col-sm-2 d-flex flex-column">
                <div class="wow fadeInUp shadow mt-2" data-wow-delay="0.1s">
                    <form action="${pageContext.request.contextPath}/user/subjectslistcontroller" method="get"
                        ...
                        <nav>
                            <ul class="pagination mb-0">
                                <li class="page-item ${currentIndex == 1 ? 'disabled' : ''}">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/user/subjectslistcontroller?page=${currentIndex - 1}">Prev</a>
                                </li>
                                <c:forEach var="i" begin="1" end="${totalPages}">
                                    <li class="page-item ${i == currentIndex ? 'active' : ''}">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}/user/subjectslistcontroller?page=${i}">${i}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item ${currentIndex == totalPages ? 'disabled' : ''}">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/user/subjectslistcontroller?page=${currentIndex + 1}">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
...
<script>
    const baseHref = `${pageContext.request.contextPath}/user/subjectslistcontroller`;
