                                    ...
                                    <tr>
                                        ...
                                        <td class="thumbnail">
                                            <c:if test="${not empty blog.blogMediaList}">
                                                ...
                                                <c:choose>
                                                    <c:when test="${fn:endsWith(firstMedia.file_path, '.mp4')
                                                                    || fn:endsWith(firstMedia.file_path, '.mov')
                                                                    || fn:endsWith(firstMedia.file_path, '.mkv')
                                                                    || fn:endsWith(firstMedia.file_path, '.avi')}">
                                                            <video width="200" controls>
                                                                <source src="${pageContext.request.contextPath}/${firstMedia.file_path}">
                                                            </video>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img src="${pageContext.request.contextPath}/${firstMedia.file_path}" width="200" />
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:if>
        ...
        <script>
                                        ...
                                        document.querySelectorAll('.delete-post-btn').forEach(button => {
                                            button.addEventListener('click', function () {
                                                ...
                                                console.log("🔄 Gán ID vào modal:", blogId);
                                        ...
                                        window.addEventListener("DOMContentLoaded", () => {
                                            if (localStorage.getItem("delete_success") === "true") {
                                                createToast("Delete successfully!", "success", 3000);
                                                ...
                                                button.addEventListener('click', function () {
                                                    ...
                                                    try {
                                                        ...
                                                        if (!mediaList || !mediaList.length) {
                                                            ...
                                                            mediaEl.classList.add('text-center');
                                                        ...
                                                        mediaList.forEach(({ mediaType, file_path, caption }) => {
                                                            ...
                                                            const mediaEl = createMediaElement(tag, file_path);
                                                            mediaContainer.appendChild(mediaEl);
