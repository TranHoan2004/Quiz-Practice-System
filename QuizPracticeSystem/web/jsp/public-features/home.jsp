                                ...
                                <c:forEach items="${latestBlogs}" var="blog">
                                    <div class="new-posts--item bg-light h-100 d-flex justify-content-center align-items-center">
                                        <div class="p-2 d-flex flex-column">
                                            <a href="${pageContext.request.contextPath}/blog-details?id=${blog.id}" class="new-posts--heading text-dark fs-6 mb-0 link-primary">
                                                ${blog.title}
                                            </a>
                                            ...
                                            <div class="d-flex gap-2">
                                                <c:if test="${not empty blog.blogMediaList}">
                                                    <img src="${pageContext.request.contextPath}/${blog.blogMediaList[0].file_path}" alt="Thumbnail"
                                ...
                                <div class="blog-item bg-light d-flex align-items-center">
                                    <div class="p-3 w-100 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100 h-100 d-flex align-content-center justify-content-between gap-4">
                                            <c:if test="${not empty blog.blogMediaList}">
                                                <img src="${pageContext.request.contextPath}/${blog.blogMediaList.get(0).file_path}" alt="Thumnail"
