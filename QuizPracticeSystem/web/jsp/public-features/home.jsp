            ...
            <div class="owl-carousel header-carousel position-relative">
                <c:forEach items="${sliderActive}" var="slider">
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="${pageContext.request.contextPath}/${slider.imageUrl}" alt=""
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-10 col-lg-8 text-center">
                                        ...
                                        <a href="${slider.backlinkUrl}"
                                           class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read
                                            More</a>
                                        <a href="${pageContext.request.contextPath}/${slider.backlinkUrl}"
        ...
        <div class="container-xxl">
            <div class="row">
                ...
                <div class="col-9 mb-5">
                    <%-- Thumbnail --%>
                    <section class="mb-6">
                        <section class="d-flex gap-3 align-items-center mb-4">
                            <a href="${pageContext.request.contextPath}/simulation-exams"
                               class="text-primary  px-2 py-1 fs-56 bread-crumb">
                                Simulation Exam
                            </a>
                            <a href="${pageContext.request.contextPath}/user/registration"
                               class="text-primary  px-2 py-1 fs-6 bread-crumb">
                                My Registration
                            </a>
                            <a href="${pageContext.request.contextPath}/blog-list"
                               class="text-primary  px-2 py-1 fs-6 bread-crumb">
                                Blog
                            </a>
                            <a href="${pageContext.request.contextPath}/jsp/public-features/subjects_list.jsp"
                               class="text-primary  px-2 py-1 fs-6 bread-crumb">
                                Subjects
                            </a>
                        </section>
                                               ...
                                               class="course-link">
                                                <div class="card h-100 shadow-sm course-card">
                                                    <img src="${pageContext.request.contextPath}/${course.image}"
                                                         class="card-img-top course-img" alt="Scratch Nâng Cao">
                                                    <div class="card-body">
                                                        <!-- HOT label -->
                                                        <div class="position-absolute top-0 start-0 bg-danger px-3 py-1 rounded-bottom-end text-white fw-semibold"
                                                             style="font-size: 0.8rem; z-index: 10;">
                                                            HOT
                                                        </div>
                                                        <h3 class="course-title h5 mb-2">${course.title}</h3>
                                                        <p class="text-muted mb-2 course-card-desc">
                                                            ${course.description}
                                                        </p>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between mt-auto">
                                                            <div>
                                                                <span class="text-danger fw-bold fs-5">
                                                                    <fmt:formatNumber value="${course.price - (course.price * course.salePrice / 100)}" type="number" groupingUsed="true"/> đ
                                                                </span>
                    ...
                    <!-- Subject Start -->
                    <c:if test="${not empty featureSubject}">
                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                                            <a class="position-relative d-block overflow-hidden"
                                               href="${pageContext.request.contextPath}/subject-detail/${featureSubject[0].id}">
                                                <img class="img-fluid w-100 h-100"
                                                     src="${pageContext.request.contextPath}/${featureSubject[0].thumbnailUrl}"
                                                     alt="">
                                        ...
                                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                                            <a class="position-relative d-block overflow-hidden"
                                               href="${pageContext.request.contextPath}/subject-detail/${featureSubject[1].id}">
                                                <img class="img-fluid w-100 h-100"
                                                     src="${pageContext.request.contextPath}/${featureSubject[1].thumbnailUrl}"
                                                     alt="">
                                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                                     style="margin: 1px;">
                                        ...
                                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                                            <a class="position-relative d-block overflow-hidden"
                                               href="${pageContext.request.contextPath}/subject-detail/${featureSubject[2].id}">
                                                <img class="img-fluid w-100 h-100"
                                                     src="${pageContext.request.contextPath}/${featureSubject[2].thumbnailUrl}"
                                                     alt="">
                                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                                     style="margin: 1px;">
                                ...
                                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                                    <a class="position-relative d-block h-100 overflow-hidden"
                                       href="${pageContext.request.contextPath}/subject-detail/${featureSubject[3].id}">
                                        <img class="img-fluid position-absolute w-100 h-100"
                                             src="${pageContext.request.contextPath}/${featureSubject[3].thumbnailUrl}"
                                             alt="Subject">
                                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                             style="margin:  1px;">
                                        ...
                                        <div class="new-posts--item bg-light h-100 d-flex justify-content-center align-items-center">
                                            <div class="p-2 d-flex flex-column">
                                                <a href="${pageContext.request.contextPath}/blog-details?id=${blog.id}"
                                                   class="new-posts--heading text-dark fs-6 mb-0 link-primary">
                                                    ${blog.title}
                                                </a>
                                                ...
                                                <div class="d-flex gap-2">
                                                    <c:if test="${not empty blog.blogMediaList}">
                                                        <img src="${pageContext.request.contextPath}/${blog.blogMediaList[0].file_path}"
                                                             alt="Thumbnail"
            ...
            <!-- Blog Start -->
            <c:if test="${not empty hottestBlogs}">
                <div class="mb-5 mt-5">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 class="section-title bg-white text-center text-primary px-3">Blog</h6>
                                    ...
                                    <div class="blog-item bg-light d-flex align-items-center">
                                        <div class="p-3 w-100 h-100 d-flex flex-column">
                                            ...
                                            <div class="w-100 h-100 d-flex align-content-center justify-content-between gap-4">
                                                <c:if test="${not empty blog.blogMediaList}">
                                                    <img src="${pageContext.request.contextPath}/${blog.blogMediaList.get(0).file_path}"
                                                         alt="Thumnail"
                                            ...
                                            <a href="${pageContext.request.contextPath}/blog-details?id=${blog.id}"
                                               class="d-flex flex-row-reverse text-decoration-underline">Click here to see more</a>
                                        </div>
                                    </div>
                                </c:forEach>
                            </div>
