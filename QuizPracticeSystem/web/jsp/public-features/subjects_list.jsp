                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="list-group list-group-flush" id="categoryFilter">
                                            ...
                                            <li class="list-group-item"><a href="#" class="text-decoration-none category-link"
                                                                           data-category="Lập trình Web" style="color: #333;">Lập trình Web</a></li>
                                            <li class="list-group-item"><a href="#" class="text-decoration-none category-link"
                                                                           data-category="Thiết kế" style="color: #333;">Thiết kế</a></li>
                                            <li class="list-group-item"><a href="#" class="text-decoration-none category-link"
                                                                           data-category="Marketing" style="color: #333;">Marketing</a></li>
                                            <li class="list-group-item"><a href="#" class="text-decoration-none category-link"
                                                                           data-category="Kinh doanh" style="color: #333;">Kinh doanh</a></li>
                                            <li class="list-group-item"><a href="#" class="text-decoration-none category-link"
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                                <a href="subject-detail.html"
                                                   ...
                                                   style="color: #212529;">
                                                    <img src="../../img/course-1.jpg" alt="Featured 1" class="rounded me-2" width="40"
                                                         height="40">
                                            ...
                                            <li class="mb-2">
                                                <a href="subject-detail.html"
                                                   class="d-flex align-items-center text-decoration-none"
                                                   style="color: #212529;">
                                                    <img src="../../img/course-2.jpg" alt="Featured 2" class="rounded me-2" width="40"
                                                         height="40">
                                            ...
                                            <li>
                                                <a href="subject-detail.html"
                                                   class="d-flex align-items-center text-decoration-none"
                                                   style="color: #212529;">
                                                    <img src="../../img/course-3.jpg" alt="Featured 3" class="rounded me-2" width="40"
                                                         height="40">
...
//                                }
        ...
        <script src="../../js/SubjectsList.js"></script>
    </body>
