                        ...
                        <div class="post-media mt-4">
                            <div class="post-content text-dark">
                                ...
                                <div class="d-flex justify-content-center mb-3">
                                    <div class="post-media mt-4">
                                        <c:if test="${not empty blogDetails.blogMediaList}">
                                            <c:forEach var="media" items="${blogDetails.blogMediaList}">
                                                <div class="text-center mb-4">
                                                    <c:choose>
                                                        <c:when test="${fn:endsWith(media.file_path, '.mp4')
                                                                        || fn:endsWith(media.file_path, '.mov')
                                                                        || fn:endsWith(media.file_path, '.avi')
