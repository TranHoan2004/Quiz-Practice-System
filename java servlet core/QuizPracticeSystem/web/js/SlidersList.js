...
/**
 * Thay đổi số lượng phần tử được hiển thị trong bảng trên mỗi trang.
 * Chỉ chấp nhận giá trị >= 2, nếu không sẽ cảnh báo người dùng.
 *
 * @event change
 * @listens document#getElementById('settingOption1')
 * @throws {Alert} Nếu giá trị nhỏ hơn 2.
 *
 * @author HoanTX
 */
...
/**
 * Hiển thị hoặc ẩn ảnh trong các thẻ slider.
 * Đồng thời cập nhật nhãn hiển thị tương ứng là "Hiện ảnh" hoặc "Ẩn ảnh".
 *
 * @event change
 * @listens document#getElementById('settingOption2')
 *
 * @global {boolean} imgHidden - Cờ xác định trạng thái ẩn ảnh.
 *
 * @author HoanTX
 */
...
/**
 * Hiển thị hoặc ẩn tên người tạo trong mỗi thẻ slider.
 * Cập nhật nội dung nhãn tương ứng.
 *
 * @event change
 * @listens document#getElementById('settingOption3')
 *
 * @global {boolean} authorHidden - Cờ xác định trạng thái ẩn tên người tạo.
 *
 * @author HoanTX
 */
...
/**
 * Hiển thị hoặc ẩn trạng thái slider (dạng nút thành công hoặc lỗi).
 * Cập nhật nhãn tương ứng là "Hiện trạng thái" hoặc "Ẩn trạng thái".
 *
 * @event change
 * @listens document#getElementById('settingOption4')
 *
 * @author HoanTX
 */
...
/**
 * Xử lý sự kiện gửi (submit) của biểu mẫu tìm kiếm slider.
 * Ngăn chặn hành vi mặc định của biểu mẫu và thực hiện tìm kiếm theo từ khóa.
 *
...
/**
 * Xử lý sự kiện thay đổi (change) của dropdown lọc trạng thái.
 * Thực hiện tìm kiếm các slider dựa trên trạng thái được chọn.
 *
 * @param {Event} e - Sự kiện thay đổi của phần tử select.
 */
